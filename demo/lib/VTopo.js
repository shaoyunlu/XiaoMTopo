	...
	*/
	...
	function CircleNode(vTopo, opt) {
	  ...
	  this.__setStatusImg = function (status) {
	    ...
	    if (status) {
	      _this.setStatusImg('light_green.png');
	      if (_this.category == 'route') {
	        _this.setImg('route.png');
	      }
	    } else {
	      _this.setStatusImg('light_grey.png');
	      if (_this.category == 'route') {
	        _this.setImg('route_disconnect.png');
	      }
	    }
	  };
	  ...
	  this.handleContactClick = function () {
	    ...
	    var img = _this.img == 'contact.png' ? 'contact_close.png' : 'contact.png';
	    self.setImg(img);
	    var parentNode1;
	    var parentNode2;
	    self.relationLinkNodeIdArray.forEach(function (tmp) {
	  ...
	  this.getParentStatus = function (parentArray) {
	    ...
	    parentArray.forEach(function (tmp) {
	      if (tmp.status) {
	        ...
	        var slave = _this.masterSlaveMapping[tmp.id];
